 ...
 */
inline void projection_init(Field<Real> * f)
{
...
constexpr int mapv1v2[4][2][2][2] = { { {{0,6},{2,8}},{{1,7},{3,9}} } , { {{2,8},{4,10}},{{3,9},{5,11}} },
    { {{6,12},{8,14}},{{7,13},{9,15}} } , { {{8,14},{10,16}},{{9,15},{11,17}} } };

constexpr int mapv0v1[4][2][2][2] = { { {{36,37},{42,43}},{{38,39},{44,45}} } , { {{38,39},{44,45}},{{40,41},{46,47}} },
    { {{42,43},{48,49}},{{44,45},{50,51}} },{ {{44,45},{50,51} },{{46,47},{52,53}} } };

constexpr int mapv0v2[4][2][2][2] =  { { {{18,24},{19,25}},{{20,26},{21,27}} } , { {{20,26},{21,27}},{{22,28},{23,29}} },
    { {{24,30},{25,31}},{{26,32},{27,33}} } , { {{26,32},{27,33}},{{28,34},{29,35}} } };

constexpr int CIC_mapv0[2][2][2][2] =   { { {{0,1},{2,3}},{{4,5},{6,7}} } , { {{4,5},{6,7}},{{8,9},{10,11}} } };
constexpr int CIC_mapv1[2][2][2][2] =   { { {{12,14},{16,18}},{{13,15},{17,19}} } , { {{16,18},{20,22}},{{17,19},{21,23}} } };
constexpr int CIC_mapv2[2][2][2][2] =   { { {{24,28},{25,29}},{{26,30},{27,31}} } , { {{28,32},{29,33}},{{30,34},{31,35}} } };
